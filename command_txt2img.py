...
def command_txt2img(prompt,model,user_id):
    ...
    if model == 'revAnimated_v11':
        prompt = prompt + ', ((upper body)), ((best quality)), ((solo)), ((masterpiece)), (detailed), (best illustration), ((cinematic light)), colorful, hyper detail, dramatic light, intricate details, (extremely detailed CG unity 8k wallpaper, masterpiece, ultra-detailed, best shadow), art by PeterMohrBacher,'+\
        ...
        prompt = prompt + ', ((upper body)), ((masterpiece)), best quality, ((solo)), the most beautiful eyes, (handsome), highly detailed face, magic effect, colorful, fantasy, Fantastic light and shadow, Scenery, mature,'+\
    ...
    prompt = prompt + f' -n 4 -s 30 -A k_dpmpp_2 --outdir /home/qkrwnstj/capston_design/invokeai/outputs/{user_id}'
